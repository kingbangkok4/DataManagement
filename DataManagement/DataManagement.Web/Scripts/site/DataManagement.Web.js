...
(function (DataManagement) {
    ...
    })(Administration = DataManagement.Administration || (DataManagement.Administration = {}));
...
(function (DataManagement) {
    ...
    })(BasicSamples = DataManagement.BasicSamples || (DataManagement.BasicSamples = {}));
})(DataManagement || (DataManagement = {}));
var DataManagement;
(function (DataManagement) {
    var BasicSamples;
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = DataManagement.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = DataManagement.Northwind.OrderDetailsEditor;
        ...
        var StaticTextBlockForm = /** @class */ (function (_super) {
            ...
            function StaticTextBlockForm(prefix) {
                ...
                if (!StaticTextBlockForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = DataManagement.StaticTextBlock;
                    var w1 = s.StringEditor;
...
(function (DataManagement) {
    ...
    })(Common = DataManagement.Common || (DataManagement.Common = {}));
})(DataManagement || (DataManagement = {}));
var DataManagement;
(function (DataManagement) {
    var Common;
...
(function (DataManagement) {
    ...
    })(Membership = DataManagement.Membership || (DataManagement.Membership = {}));
})(DataManagement || (DataManagement = {}));
var DataManagement;
(function (DataManagement) {
    var Membership;
...
(function (DataManagement) {
    ...
    })(Northwind = DataManagement.Northwind || (DataManagement.Northwind = {}));
})(DataManagement || (DataManagement = {}));
var DataManagement;
(function (DataManagement) {
    var Northwind;
...
(function (DataManagement) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'DataManagement.Northwind.Gender', 'DataManagement.Northwind.Entities.Gender');
    })(Northwind = DataManagement.Northwind || (DataManagement.Northwind = {}));
})(DataManagement || (DataManagement = {}));
var DataManagement;
(function (DataManagement) {
...
(function (DataManagement) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(OrderShippingState, 'DataManagement.Northwind.OrderShippingState', 'Northwind.OrderShippingState');
    })(Northwind = DataManagement.Northwind || (DataManagement.Northwind = {}));
})(DataManagement || (DataManagement = {}));
var DataManagement;
(function (DataManagement) {
...
(function (DataManagement) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = DataManagement.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = DataManagement.LanguageList || (DataManagement.LanguageList = {}));
})(DataManagement || (DataManagement = {}));
...
(function (DataManagement) {
    ...
    (function (ScriptInitialization) {
        ...
        Q.Config.rootNamespaces.push('DataManagement');
        Serenity.EntityDialog.defaultLanguageList = DataManagement.LanguageList.getValue;
        if ($.fn['colorbox']) {
            $.fn['colorbox'].settings.maxWidth = "95%";
            $.fn['colorbox'].settings.maxHeight = "95%";
        }
        window.onerror = Q.ErrorHandling.runtimeErrorHandler;
    })(ScriptInitialization = DataManagement.ScriptInitialization || (DataManagement.ScriptInitialization = {}));
})(DataManagement || (DataManagement = {}));
var DataManagement;
(function (DataManagement) {
    var Administration;
...
(function (DataManagement) {
    ...
    DataManagement.BasicProgressDialog = BasicProgressDialog;
})(DataManagement || (DataManagement = {}));
var DataManagement;
(function (DataManagement) {
    var Common;
    (function (Common) {
        var BulkServiceAction = /** @class */ (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new DataManagement.BasicProgressDialog();
...
(function (DataManagement) {
    ...
    })(DialogUtils = DataManagement.DialogUtils || (DataManagement.DialogUtils = {}));
})(DataManagement || (DataManagement = {}));
var DataManagement;
(function (DataManagement) {
    var Common;
...
(function (DataManagement) {
    ...
    DataManagement.StaticTextBlock = StaticTextBlock;
})(DataManagement || (DataManagement = {}));
var DataManagement;
(function (DataManagement) {
    var Common;
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                DataManagement.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
    ...
    (function (Northwind) {
        var CustomerGrid = /** @class */ (function (_super) {
            ...
            CustomerGrid.prototype.getButtons = function () {
                ...
                buttons.push(DataManagement.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    service: 'Northwind/Customer/ListExcel',
                    separator: true
                }));
                buttons.push(DataManagement.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); }
                }));
                return buttons;
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(DataManagement.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
                    cssClass: 'export-pdf-button',
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        DataManagement.Common.ReportHelper.execute({
                            reportKey: 'Northwind.OrderDetail',
                            params: {
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: DataManagement.Authorization.userDefinition.DisplayName,
...
(function (DataManagement) {
    ...
    (function (Northwind) {
        ...
        }(DataManagement.Common.GridEditorDialog));
...
(function (DataManagement) {
    ...
    (function (Northwind) {
        ...
        }(DataManagement.Common.GridEditorBase));
    ...
    (function (Northwind) {
        var RegionDialog = /** @class */ (function (_super) {
            ...
            RegionDialog.prototype.getLanguages = function () {
                return DataManagement.LanguageList.getValue();
            };
...
(function (DataManagement) {
    ...
    })(Authorization = DataManagement.Authorization || (DataManagement.Authorization = {}));
})(DataManagement || (DataManagement = {}));
var DataManagement;
(function (DataManagement) {
    var BasicSamples;
...
(function (DataManagement) {
    ...
    (function (BasicSamples) {
        ...
        }(DataManagement.Northwind.ProductDialog));
...
(function (DataManagement) {
    ...
    (function (BasicSamples) {
        ...
        }(DataManagement.Northwind.ProductGrid));
...
(function (DataManagement) {
    ...
    (function (BasicSamples) {
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: DataManagement.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: DataManagement.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new DataManagement.Northwind.OrderDialog();
                        ...
                        var chai = DataManagement.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = DataManagement.Northwind.EmployeeRow.getLookup().items
        ...
        }(DataManagement.Northwind.OrderGrid));
...
(function (DataManagement) {
    ...
    (function (BasicSamples) {
        ...
        }(DataManagement.Northwind.OrderDialog));
...
(function (DataManagement) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    DataManagement.Northwind.CategoryService.Retrieve({
        ...
        }(DataManagement.Northwind.CategoryDialog));
...
(function (DataManagement) {
    ...
    (function (BasicSamples) {
        ...
        }(DataManagement.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(DataManagement.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new DataManagement.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                DataManagement.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(DataManagement.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    DataManagement.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(DataManagement.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(DataManagement.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    DataManagement.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return DataManagement.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return DataManagement.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return DataManagement.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return DataManagement.Northwind.OrderService.baseUrl; };
...
(function (DataManagement) {
    ...
    (function (BasicSamples) {
        ...
        }(DataManagement.Northwind.SupplierDialog));
...
(function (DataManagement) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = /** @class */ (function (_super) {
            ...
            return ReadOnlyGrid;
        }(DataManagement.Northwind.SupplierGrid));
...
(function (DataManagement) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = /** @class */ (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return DataManagement.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return DataManagement.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return DataManagement.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return DataManagement.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return DataManagement.Northwind.OrderService.baseUrl; };
...
(function (DataManagement) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    DataManagement.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(DataManagement.Northwind.CustomerDialog));
...
(function (DataManagement) {
    ...
    (function (BasicSamples) {
        ...
        }(DataManagement.Northwind.CustomerGrid));
        ...
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    var productID = Q.toId(_this.form.ProductID.value);
                    if (productID != null) {
                        _this.form.UnitPrice.value = DataManagement.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
                _this.form.Discount.addValidationRule(_this.uniqueName, function (e) {
                    var price = _this.form.UnitPrice.value;
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return DataManagement.Northwind.OrderDetailRow.localTextPrefix; };
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return DataManagement.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new DataManagement.Northwind.OrderDetailForm(_this.idPrefix);
        ...
        }(DataManagement.Northwind.OrderDetailDialog));
...
(function (DataManagement) {
    ...
    (function (BasicSamples) {
        ...
        }(DataManagement.Northwind.OrderDetailsEditor));
...
(function (DataManagement) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return DataManagement.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return DataManagement.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return DataManagement.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return DataManagement.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return DataManagement.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (DataManagement) {
    ...
    (function (BasicSamples) {
        ...
        }(DataManagement.Common.BulkServiceAction));
...
(function (DataManagement) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return DataManagement.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return DataManagement.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return DataManagement.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return DataManagement.Northwind.ProductService.baseUrl; };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(DataManagement.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new DataManagement.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new DataManagement.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new DataManagement.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (DataManagement) {
    ...
    DataManagement.SelectableEntityGrid = SelectableEntityGrid;
})(DataManagement || (DataManagement = {}));
...
(function (DataManagement) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return DataManagement.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return DataManagement.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return DataManagement.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return DataManagement.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(DataManagement.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = DataManagement.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            DataManagement.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (DataManagement) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return DataManagement.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return DataManagement.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return DataManagement.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return DataManagement.Northwind.ProductService.baseUrl; };
...
(function (DataManagement) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return DataManagement.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return DataManagement.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return DataManagement.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return DataManagement.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (DataManagement) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return DataManagement.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return DataManagement.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (DataManagement) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return DataManagement.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return DataManagement.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return DataManagement.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
//# sourceMappingURL=DataManagement.Web.js.map